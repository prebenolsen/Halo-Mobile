...
const CFG = {
  ...
  CONVECT_AMPLITUDE: 6.0, COLUMN_AMPLITUDE: 8.0,
  ACTIVITY_ZONE_COUNT: 4,
  ACTIVITY_ZONE_SPREAD: 3.0,
  ACTIVITY_DRIFT_SPEED: 0.025,
  ACTIVITY_FLUX_SPEED: 0.08,
  ACTIVITY_FLUX_DEPTH: 0.65,
  ACTIVITY_BASE: 0.25,
  SHELL_RADIUS_MULT: 1.06,
  SHELL_TURB_FREQ_A: 0.055, SHELL_TURB_FREQ_B: 0.095, SHELL_TURB_SPEED: 0.16,
  SHELL_TEAR_THRESH: -0.1, SHELL_TEAR_SHARP: 0.5, SHELL_LIFT: 8.0,
  FLAME_COUNT: 2000,
  FLAME_SPEED_MIN: 12, FLAME_SPEED_MAX: 40, FLAME_JITTER: 0.35,
  FLAME_LIFE_MIN: 0.3, FLAME_LIFE_MAX: 1.8,
  FLAME_SIZE_MIN: 2.0, FLAME_SIZE_MAX: 10.0, FLAME_CURL: 0.8, FLAME_DECAY: 1.5,
  FLAME_ACTIVITY_SPEED_BOOST: 20, FLAME_ACTIVITY_SIZE_BOOST: 15,
  HALO_BREATHE_SPEED: 0.7, HALO_BREATHE_DEPTH: 0.12,
  HALO1_OPACITY: 0.85, HALO2_OPACITY: 0.55, HALO3_OPACITY: 0.30,
  STAR_COUNT: 3000, STAR_SIZE: 2, STAR_OPACITY: 0.65,
}
